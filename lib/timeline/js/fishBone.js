        ...
        $(data).each(function(index) {
            ...
            if(itemclass=='top'){
                $.each(this, function (name, value) {
                    if (name == 'peisOperationTime') {
                        if (value != null && value != "" && value !="0001/1/1 0:00:00") //处理时间
                ...
                $.each(this, function (name, value) {
                    if (name == 'peisOperationName') {
                        if (value == null) {
                            var li = $("<li class='title'></li>");
                            var titleLeft = $("<span class='title-left'>&nbsp;</span>").css('background-position-y', titleLeftY);
                            var titleCenter = $("<span class='title-center'>暂未执行，请等待</span>").css('background-position-y', titleCenterY);
            ...
            //封装其他属性
            $.each(this, function (name, value) {
                if (name != 'peisOperationName' && name != 'peisOperationTime') {
                    if (value == null || value == "" || value=="位置为空")//占位
                        value = "&nbsp;&nbsp;";
