(function (global, factory) {
	...
	*/
	...
	var METHODS = ['getOptions', 'refreshOptions', 'getData', 'getSelections', 'load', 'append', 'prepend', 'remove', 'removeAll', 'insertRow', 'updateRow', 'getRowByUniqueId', 'updateByUniqueId', 'removeByUniqueId', 'getRowByIndex','removeByIndex', 'updateCell', 'updateCellByUniqueId', 'showRow', 'hideRow', 'getHiddenRows', 'showColumn', 'hideColumn', 'getVisibleColumns', 'getHiddenColumns', 'showAllColumns', 'hideAllColumns', 'mergeCells', 'checkAll', 'uncheckAll', 'checkInvert', 'check', 'uncheck', 'checkBy', 'uncheckBy', 'refresh', 'destroy', 'resetView', 'showLoading', 'hideLoading', 'togglePagination', 'toggleFullscreen', 'toggleView', 'resetSearch', 'filterBy', 'scrollTo', 'getScrollPosition', 'selectPage', 'prevPage', 'nextPage', 'toggleDetailView', 'expandRow', 'collapseRow', 'expandRowByUniqueId', 'collapseRowByUniqueId', 'expandAllRows', 'collapseAllRows', 'updateColumnTitle', 'updateFormatText'];
	var EVENTS = {
		'all.bs.table': 'onAll',
		...
		_createClass(BootstrapTable, [{
			...
			value: function resetView(params) {
				...
				if (this.$container.hasClass('fullscreen')) {
					...
					//多余搜索框高度
					var fixedTableToolbar = $(".fixed-table-toolbar").height();
					if (fixedTableToolbar != 0) {
						fixedHeight = fixedTableToolbar;
					}
					else {
						fixedTableToolbar = fixedHeight;
					}
					...
					if (this.options.height.toString().indexOf("%") != -1) {
						height = this.$container.parent().height() * (parseFloat(this.options.height) / 100);
					}
					height = height - paginationHeight - fixedHeight;
